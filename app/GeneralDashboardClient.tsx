                ...
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-slate-700 text-sm">Book Appointment</span>
                        </div>
                        <PlusCircle className="w-4 h-4 text-slate-300 group-hover:text-brand-600 transition-colors" />
                    </button>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-slate-700 text-sm">Collect Payment</span>
                        </div>
                ...
                <div className="space-y-4">
                    {patientAnalytics.categoryDistribution.map((cat: any) => (
                        <div key={cat.category}>
                            <div className="flex justify-between text-xs font-bold mb-1.5">
                                <span className="text-slate-500 uppercase tracking-wider">{cat.category}</span>
                            ...
                            <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                                <div
                                    ...
                                    style={{ width: `${(cat.count / patientAnalytics.totalPatients) * 100}%` }}
                                />
                            </div>
                        </div>
                    ))}
                    <div className="pt-4 border-t border-slate-50 mt-4 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-slate-500">Growth Rate</span>
                        </div>
                        <span className="text-sm font-black text-slate-900">+{patientAnalytics.newPatientsLast30Days} New</span>
                    </div>
                </div>
            </Card>
        </div>
