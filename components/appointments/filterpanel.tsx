...
import { Appointment, ExtendedAppointment, ExtendedUserSession } from "@/lib/types";
    ...
    return (
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-wrap gap-4 items-center">
            ...
            <button
                ...
                className={`px-5 py-3 rounded-xl font-medium flex items-center gap-2 transition ${showTodayOnly
