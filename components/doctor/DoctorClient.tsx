...
export default function DoctorClient({
  ...
  return (
    <div className="flex h-full bg-[#f8fafc]">
      ...
      <div
        className={`flex flex-col border-r border-slate-200 bg-white transition-all duration-300 ${isSidebarCollapsed && selectedPatient ? "w-0 overflow-hidden" : "w-80 lg:w-96"}`}
      >
          ...
          <div>
            <div className="flex items-center gap-2 mb-3 px-2">
              ...
              <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                Waiting for Review ({filteredPatients.pending.length})
              </h3>
            </div>
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-xs ${selectedPatient?.id === p.id ? "bg-emerald-500 text-white" : "bg-slate-100 text-slate-500"}`}
                      >
                        {p.firstName[0]}
                        {p.lastName[0]}
                      </div>
                      <div>
                        <p
                          className={`font-bold text-sm ${selectedPatient?.id === p.id ? "text-emerald-900" : "text-slate-900"}`}
                        >
          ...
          {filteredPatients.completedToday.length > 0 && (
            <div>
              <div className="flex items-center gap-2 mb-3 px-2">
                ...
                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  Finalized Today ({filteredPatients.completedToday.length})
                </h3>
              </div>
        ...
        {selectedPatient ? (
            ...
            <div className="flex-1 overflow-y-auto p-8 bg-[#f8fafc]">
              <div className="max-w-5xl mx-auto pb-20">
                ...
                >
                  ...
                  <div
                    className={`${activeTab !== "Subjective" ? "hidden" : "block"} space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500`}
                  >
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                          ...
                          <div className="grid grid-cols-1 gap-2">
                            {MEDICAL_CONDITIONS.map((condition) => (
                              ...
                              >
                                <span
                                  className={`text-[11px] font-bold ${selectedConditions.includes(condition.id) ? "text-emerald-700" : "text-slate-600"}`}
                                >
                                  {condition.label}
                                </span>
                                <div
                                  className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${selectedConditions.includes(condition.id) ? "bg-emerald-500 border-emerald-500" : "border-slate-300"}`}
                                >
                  ...
                  <div
                    className={`${activeTab !== "Objective" ? "hidden" : "block"} space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500`}
                  >
                    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col md:flex-row">
                      ...
                      <div className="w-full md:w-80 border-r border-slate-100 p-6 bg-slate-50/30">
                        ...
                        <div className="aspect-[3/4] bg-slate-200 rounded-2xl mb-6 flex items-center justify-center overflow-hidden relative group">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div
                              className="w-2 h-2 bg-red-500 rounded-full shadow-[0_0_10px_rgba(239,68,68,0.8)] animate-ping"
                              style={{
                                top: "65%",
                                left: "45%",
                                position: "absolute",
                      ...
                      <div className="flex-1 p-8 space-y-10">
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              {[
                                ...
                                <div
                                  key={item.id}
                                  className="bg-slate-50/50 p-4 rounded-2xl border border-slate-100 flex items-center justify-between"
                                >
                                  ...
                                  <div className="flex items-center gap-1">
                                    <input
                                      type="text"
                                      value={
                                        (objectiveData.rom as any)[item.id]
                                      }
                                      onChange={(e) =>
                                        setObjectiveData({
                                          ...objectiveData,
                        ...
                        {/* Muscle Strength */}
                        <div>
                          <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6 block">
                  ...
                  <div
                    className={`${activeTab !== "Medical Record" ? "hidden" : "block"} space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500`}
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                          ...
                          <div className="space-y-6 max-h-[600px] overflow-y-auto pr-2">
                            ...
                            <div className="bg-slate-50/50 rounded-2xl border border-slate-100 overflow-hidden">
                              <div className="bg-slate-900 px-4 py-2 flex justify-between items-center">
                                ...
                                <span className="text-[10px] font-bold text-slate-400">
                                  {selectedPatient.diagnoses?.[0]?.updatedAt ||
                                  ...
                                  <div className="flex gap-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-xs font-black text-red-500">
                                        {selectedPatient.diagnoses?.[0]
                                          ?.vasScore ||
                                          selectedPatient.diagnosis?.vasScore ||
                                          0}
                                        /10
                                      </p>
                                    </div>
                            ...
                            <div>
                              <p className="text-[10px] font-black text-slate-400 uppercase mb-3 px-1 flex items-center gap-2">
                                <History className="w-3 h-3" /> Visit &
                                Procedure History
                              </p>
                              <div className="space-y-2">
                                {selectedPatient.procedures?.map((proc, i) => (
                                  <div
                                    key={i}
                                    className="p-4 bg-white border border-slate-100 rounded-2xl shadow-sm flex justify-between items-center group hover:border-emerald-200 transition-all"
                                  >
                                    <div>
                                ...
                                {(!selectedPatient.procedures ||
                                  ...
                                  <div className="py-8 text-center bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
                                    <p className="text-xs text-slate-400 italic">
                                      No historical procedures found.
                                    </p>
                                  </div>
                                )}
                              </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                          ...
                          <textarea
                            name="complaints"
                            defaultValue={
                              selectedPatient.medicalRecord?.complaints || ""
                            }
                            rows={6}
                            className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-emerald-500 outline-none transition-all text-slate-700 font-medium resize-none"
                  ...
                  <div
                    className={`${activeTab !== "Diagnosis" ? "hidden" : "block"} space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500`}
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
                        <div>
                          <label className="text-[10px] font-black text-emerald-600 uppercase tracking-widest mb-3 block">
                            Clinical Diagnosis
                          </label>
                          <textarea
                            name="treatmentPlan"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setReferredDoctorId(e.target.value)
                              }
                          ...
                          {catalog.map((item) => (
                            ...
                            >
                              <div className="text-left">
                                <p
                                  className={`text-[11px] font-bold ${selectedProcedures.includes(item.name) ? "text-emerald-700" : "text-slate-600"}`}
                                >
                                  {item.name}
                                </p>
                              ...
                              <div
                                className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${selectedProcedures.includes(item.name) ? "bg-emerald-500 border-emerald-500" : "border-slate-300"}`}
                              >
                                {selectedProcedures.includes(item.name) && (
                      ...
                      <div className="flex gap-4 items-center">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 text-[10px] uppercase tracking-widest">
                            Signed by Dr.{" "}
                            {selectedPatient.medicalRecord?.assignedDoctor
                              ?.username || "Doctor"}
                          </p>
                        </div>
                      </div>
          ...
          <div className="h-full flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="text-slate-400 text-sm mt-3 max-w-xs font-medium">
              Please select a patient from the pending list to begin their
              clinical assessment.
            </p>
            {searchTerm &&
              filteredPatients.pending.length === 0 &&
