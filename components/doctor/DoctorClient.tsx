                    ...
                    >
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-4">
                          <div
                            className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-base shadow-sm ${isCompleted ? "bg-emerald-100 text-emerald-600" : "bg-indigo-50 text-indigo-600"}`}
                          >
                            {p.firstName[0]}
                            {p.lastName[0]}
                          </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 text-[11px] text-slate-400 font-black uppercase tracking-widest mt-2">
                      ...
                      <span className="text-emerald-500">
                        ID: #{selectedPatient.id.slice(-6).toUpperCase()}
                      </span>
                    </div>
                  </div>
                </div>
                                    ...
                                    {[0, 1, 2, 3, 4, 5].map((score) => (
                                      <button
                                        ...
                                        className={`w-8 h-8 rounded-lg flex items-center justify-center text-[11px] font-black transition-all border ${
                                          objectiveData.strength[item.id] ===
                                          score
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  {(!selectedPatient.procedures ||
                                    selectedPatient.procedures.length ===
                                      0) && (
